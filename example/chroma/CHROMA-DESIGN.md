...
- **Stroke width**: 2
- **Sizes**: 14px (buttons, inline), 16px (inputs, headings)
- **Color**: inherits from parent text color (`textTertiary` for decorative, `textPrimary` for action)
- **Usage**: paired with text labels inside buttons; standalone only in icon-only buttons (theme toggle)
- **Current icons**: Copy, Check, Share2, Sun, Moon, Pipette, Clock, ExternalLink
...
3. Three weights: 400 (read), 510 (emphasize/navigate), 590 (strong emphasis)
